...
- [ ] Loop 2: database schema (flats, members, expenses, shares) with Drizzle and Neon, migration workflow
- [ ] Loop 3: settlement engine — net balances and minimum-transfer algorithm, fully unit tested
